const data = {
    general: {
        ...
        SUDO_PERMISSION:
            "```Hey there, I am 💠Bot of Arin💠. I guess you were trying to use my commands in``` *{BotsApp.groupName}*```. However, the bot is currently in {worktype} mode. This enables only the owner and sudo users to use the command``` *{commandName}* ```.\n\nIf you are keen to use my features, you can deploy BotArin on your own account without much effort, in less than 5 minutes! Check out the links given below.```\n\n🔗https://github.com/arinish/botarin\n🔗https://github.com/arinish/botarin",
        ERROR_TEMPLATE:
    ...
    getdp: {
        ...
        EXTENDED_DESCRIPTION: "```Get the profile picture of the group in a group conversation or the profile picture of BotArin itself in personal chat. Tag a person in a group to get their profile picture.```",
        IMAGE_CAPTION: "```Here is the display image. Procured by Arin-ish.```",
    ...
    help: {
        ...
        TEMPLATE: "\n\n🤖 *Command* - ```{}```\n💡 *Info* - ```{}```",
        COMMAND_INTERFACE: "🌀 *BotArin Command Interface* 🌀\n\n",
    ...
    rename: {
        ...
        ERROR: "```Woops, something went wrong. Dhyan se dekh aur Try again, or proabaly not with this again...```"
    ...
    song: {
        ...
        DOWNLOADING: "```Datt Jaa..Downloading your song...```",
    ...
    sticker: {
        ...
        DOWNLOADING: "```Your free ka sticker is downloading. Please wait...```"
    },
    stoi: {
